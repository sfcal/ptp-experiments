...
#include <linux/version.h>
	...
	RHEL_RELEASE_CODE >= RHEL_RELEASE_VERSION(10, 3)
#define iio_device_claim_direct_mode(indio_dev) \
	(iio_device_claim_direct(indio_dev) ? 0 : -EBUSY)
#define iio_device_release_direct_mode(indio_dev) \
